...
To make the data usable for reporting, I unpivoted and cleaned the data in Power Query. Then, to create a clean reporting table that separates actual amounts from budget amounts by item and month.
